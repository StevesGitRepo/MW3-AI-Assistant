...
using ChefGPT.Server.ChatEndpoint;
...
namespace ChefGPT.Server.Services
{
    public class OpenAIService : IOpenAIAPI
    {
        ...
        //build the function object in order for AI will return JSON formatted objects
        ...
        //CONSTRUCTOR - Standard Http client for sending in an API key
